-- Migration: Add auth + credits tables
-- Run: npx wrangler d1 execute img2ui-db --file=worker/migration-auth.sql --remote

-- Add user_id column to existing design_tokens table
ALTER TABLE design_tokens ADD COLUMN user_id TEXT;
