...
8. **エクスポート** — JSON、SKILL.md（コーディングエージェント向け）、DESIGN.md（Google Stitch向け）、スタンドアロンHTML
...
画像アップロード
  ...
  → エクスポート（JSON / SKILL.md / DESIGN.md / HTML）
```
...
- [ ] **Figmaエクスポート（code.to.design）** — [code.to.design](https://code.to.design/) APIを統合し、生成されたデザイントークンとコンポーネントをFigmaに直接プッシュ
